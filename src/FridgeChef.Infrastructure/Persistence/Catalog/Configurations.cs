...
internal sealed class RecipeConfiguration : IEntityTypeConfiguration<Recipe>
{
    ...
    private static RecipeStatus SafeParseStatus(string v) =>
        Enum.TryParse<RecipeStatus>(v.Replace("_", ""), true, out var k) ? k : RecipeStatus.Published;
}
...
internal sealed class RecipeSectionConfiguration : IEntityTypeConfiguration<RecipeSection>
{
...
internal sealed class RecipeMediaConfiguration : IEntityTypeConfiguration<RecipeMedia>
{
    ...
    private static MediaKind SafeParseMediaKind(string v) =>
        Enum.TryParse<MediaKind>(v.Replace("_", ""), true, out var k) ? k : MediaKind.Hero;
}

internal sealed class RecipeNutritionConfiguration : IEntityTypeConfiguration<RecipeNutrition>
{
    public void Configure(EntityTypeBuilder<RecipeNutrition> builder)
    {
        ...
        builder.HasOne(n => n.Recipe).WithOne(r => r.Nutrition).HasForeignKey<RecipeNutrition>(n => n.RecipeId);
    }
}
...
internal sealed class RecipeTaxonConfiguration : IEntityTypeConfiguration<RecipeTaxon>
{
    public void Configure(EntityTypeBuilder<RecipeTaxon> builder)
    {
...
internal sealed class RecipeAllergenConfiguration : IEntityTypeConfiguration<RecipeAllergen>
{
    public void Configure(EntityTypeBuilder<RecipeAllergen> builder)
    {
